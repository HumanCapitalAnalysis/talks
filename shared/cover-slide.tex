{
	\setbeamertemplate{background}{\tikz[overlay,remember picture]\node[opacity=0.4]at (current page.center){\includegraphics[width=13cm]{../../../shared/cover-slide-econometrics.png}};}
...
anCapitalAnalysis/micromeetrics}{\includegraphics[height=0.8cm]{../../../shared/cover-slide-github.png}}}
	% Github Text
	...
	\put(5.5,6){\begin{minipage}[t]{0.4\linewidth}
		...
		\end{minipage}}
	% Uni Bonn Logo
	\put(230,0){\includegraphics[height=1cm]{../../../shared/cover-slide-uni-bonn.png}}
	% Cover Text and Author
	\put(180,230){\begin{minipage}[t]{0.4\linewidth}
		{{\color{darkgray!85!blue}{ \Huge {\slshape T}}}{{\color{darkgray}\large \slshape alks}} \\ \vspace{-5.5pt} \\
