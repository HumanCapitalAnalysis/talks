...
\subfloat[]{
\scalebox{0.3}{\includegraphics{fig-academic-writing-1}}}\hspace{0.5cm}
\subfloat[]{
\scalebox{0.3}{\includegraphics{fig-academic-writing-2}}}
\end{figure}
\end{frame}
...
\caption{Book Recommendations}
\subfloat[]{
\scalebox{0.3}{\includegraphics{fig-academic-presentation-1}}}\hspace{0.5cm}
\subfloat[]{
\scalebox{0.3}{\includegraphics{fig-academic-research-1}}}
\end{figure}
\end{frame}
...
\begin{align*}
V(s) = & \int_0^{T(s) - s} (1 - \tau) \exp^{-(1 - \tau)r(x + s)} Y(s,x) dx \\
       & - \int^s_0 v\exp^{-(1 - \tau)rz}dz
\end{align*}
\end{frame}
...
\begin{align*}
& [T^\prime(s) - 1]\exp^{-(1 - \tau)r(T(s) - s)} Y(s, T(s) - s) \\
& - (1 - \tau)r\int^{T(s) - s}_0 \exp^{-(1 - \tau)rx} Y(s, x)dx \\
& + \int_0^{T(s) - s} \exp^{-(1 - \tau) rx} \frac{\partial Y(s, x)}{\partial s}dx \\
& - \frac{v}{ 1  -\tau} = 0
\end{align*}
\end{frame}
%-------------------------------------------------------------------------------
