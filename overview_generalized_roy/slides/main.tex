...
\begin{figure}[htp]\centering
	\caption{Conditional Expectation}\label{eh-Conditional Expectation}\scalebox{0.35}{\includegraphics{fig-eh-conditional-expectation.png}}
\end{figure}
...
\begin{figure}[htp]\centering
	\caption{Treatment Effects with Essential Heterogeneity}\label{Treatment Effects Conventional}\scalebox{0.35}{\includegraphics{fig-treatment-effects-conventional.png}}
\end{figure}
...
%\scalebox{0.18}{\includegraphics{fig-online-documentation.png}}
\end{figure}
