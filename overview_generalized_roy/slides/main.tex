...
\begin{figure}[htp]\centering
	...
	\scalebox{0.80}{\includegraphics{./material/fig-distribution-potential_wolabel.png}}
\end{figure}
\end{frame}
...
\begin{figure}[htp]\centering
	...
	\scalebox{0.80}{\includegraphics{./material/fig-distribution-surplus_wolabel.png}}
\end{figure}
\end{frame}
