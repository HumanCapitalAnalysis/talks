...
\scalebox{0.75}{\includegraphics{fig-early-late}}
...
\scalebox{0.60}{\includegraphics[angle=270]{fig-signal-noise-1}}
\end{figure}\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{frame}\begin{figure}\caption{Signal and Noise for Investment}\vspace{-0.6cm}
\scalebox{0.60}{\includegraphics[angle=270]{fig-signal-noise-2}}
\end{figure}\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
\begin{frame}\begin{figure}\caption{Baseline Estimates}\vspace{0.3cm}
\scalebox{0.50}{\includegraphics{fig-estimates-1}}
\end{figure}\end{frame}
%-------------------------------------------------------------------------------
%-------------------------------------------------------------------------------
